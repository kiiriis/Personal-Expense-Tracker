...
// List of type of currencies.
  List<String> values = ["INR", "USA", "CAN", "EUR"];
                                ...
                                Text(
                                  ...
                                  _dateTime.day == DateTime.now().day
                                      ...
                                      : DateFormat.yMMMEd().format(
                                          _dateTime), // If selected date is any date occuring before current date.
                                  style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 17,
                                      fontWeight: FontWeight.bold),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "${values2[selectedCurrency]} ${(totalExpense - totalIncome).abs()}")
                                ],
                              ),
                            ),
                          ],
